...
- Name: chaos.spec.ts >> Chaos Engineering tests - Resilience against backend failures >> Malformed JSON response test on Trade processing handles exception gracefully
- Location: tests/e2e/chaos.spec.ts:40:5
...
- generic [ref=e3]:
  ...
  - main [ref=e65]:
    - generic [ref=e66]:
      - heading "Trade History" [level=2] [ref=e67]
      - generic [ref=e68]: "Error loading trades: Request failed with status code 500"
```
