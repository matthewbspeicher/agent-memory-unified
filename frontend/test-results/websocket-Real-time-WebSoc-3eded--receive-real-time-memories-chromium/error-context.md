...
- Name: websocket.spec.ts >> Real-time WebSocket Feed >> should connect to websocket and receive real-time memories
- Location: tests/e2e/websocket.spec.ts:31:3
...
Locator: locator('text=Initial Memory')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Initial Memory')
