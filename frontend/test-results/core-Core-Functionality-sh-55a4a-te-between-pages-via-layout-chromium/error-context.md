...
- Name: core.spec.ts >> Core Functionality >> should navigate between pages via layout
- Location: tests/e2e/core.spec.ts:58:3
...
Call log:
  ...
  - waiting for locator('h2').first()
    9 × locator resolved to <h2>Unexpected Application Error!</h2>
