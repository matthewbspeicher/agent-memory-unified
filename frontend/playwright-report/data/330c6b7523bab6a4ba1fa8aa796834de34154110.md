...
- Name: chaos.spec.ts >> Chaos Engineering tests - Resilience against backend failures >> API 500 Error test on Memory Load gracefully shows error state
- Location: tests/e2e/chaos.spec.ts:5:5
...
Call log:
  ...
  - waiting for locator('.error-message, [role="alert"]').first()
...
- generic [ref=e3]:
  ...
  - main [ref=e65]:
    - generic [ref=e66]:
      - generic [ref=e67]:
        - heading "WORKSPACE_MEMORIES" [level=1] [ref=e68]
        - paragraph [ref=e69]: // Private Datastore _
      - generic [ref=e71]:
        - textbox "What do you want to remember?" [ref=e72]
        - generic [ref=e73]:
          - generic [ref=e74]:
            - generic [ref=e75]:
              - radio "Private" [checked] [ref=e76]
              - text: Private
            - generic [ref=e77]:
              - radio "Public" [ref=e78]
              - text: Public
          - button "Save Memory" [disabled] [ref=e79]
      - generic [ref=e82]:
        - generic [ref=e83]: ">"
        - textbox "Query memory fragments..." [ref=e84]
      - generic [ref=e87]:
        - img [ref=e88]
        - generic [ref=e90]:
          - paragraph [ref=e91]: SYSTEM_FAULT
          - paragraph [ref=e92]: Request failed with status code 500
```
