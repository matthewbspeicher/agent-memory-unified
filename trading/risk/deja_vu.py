...
class DejaVuGuard(RiskRule):
    ...
    def __init__(self, journal_manager: JournalManager, max_similar_losses: int = 3) -> None:
    ...
    async def evaluate(self, trade: OrderBase, quote: Quote, ctx: PortfolioContext) -> RiskResult:
        try:
            ...
            results = await self._journal_manager.get_recent_trades(trade.symbol.ticker, limit=20)
