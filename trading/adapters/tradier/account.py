...
from broker.models import (
    Account, AccountBalance, AssetType, OptionRight, OrderHistoryFilter,
    OrderResult, OrderStatus, Position, Symbol,
)
...
class TradierAccountProvider(AccountProvider):
    ...
    async def get_positions(self, account_id: str) -> list[Position]:
        ...
        for p in raw:
            ...
            positions.append(Position(
                ...
                avg_cost=Decimal(str(p.get("cost_basis", 0))) / max(Decimal(str(abs(p.get("quantity", 1)))), Decimal("1")),
                market_value=Decimal("0"),  # Tradier doesn't return market_value in positions
    ...
    async def get_balances(self, account_id: str) -> AccountBalance:
        ...
        return AccountBalance(
            ...
            buying_power=Decimal(str(bal.get("option_buying_power", bal.get("stock_buying_power", 0)))),
    ...
    async def get_order_history(
        ...
        for o in raw:
            ...
            results.append(OrderResult(
                ...
                filled_quantity=Decimal(str(o.get("exec_quantity", o.get("quantity", 0)))),
                avg_fill_price=Decimal(str(o["avg_fill_price"])) if o.get("avg_fill_price") else None,
            ))
        return results
