...
async def test_place_market_order_filled_immediately():
    ...
    mock_client.submit_order = AsyncMock(return_value={
        ...
        "filled_qty": "10", "filled_avg_price": "150.25",
    })
...
async def test_place_order_polls_until_filled():
    ...
    mock_client.get_order = AsyncMock(side_effect=[
        {"id": "ord1", "status": "partially_filled", "filled_qty": "5", "filled_avg_price": "150.0"},
        {"id": "ord1", "status": "filled", "filled_qty": "10", "filled_avg_price": "150.25"},
    ])
