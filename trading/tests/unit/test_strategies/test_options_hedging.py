...
from broker.models import Symbol, AssetType, Position, OptionsChain, ContractDetails, Quote
...
class MockBrokerMarketData:
    ...
    async def get_options_chain(self, symbol):
        ...
        return OptionsChain(
            ...
            strikes=[Decimal("130"), Decimal("140"), Decimal("150"), Decimal("160"), Decimal("170")]
        )
