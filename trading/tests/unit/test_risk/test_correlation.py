...
def test_pearson_correlation_edge_cases():
    ...
    assert pearson_correlation([Decimal("1"), Decimal("2")], [Decimal("1")]) == 0.0  # Mismatched length
    # Flat line
    assert pearson_correlation([Decimal("1"), Decimal("2")], [Decimal("5"), Decimal("5")]) == 0.0

def test_avg_portfolio_correlation():
    h = {
        "AAPL": [Decimal("1"), Decimal("2"), Decimal("3"), Decimal("4")],
        "MSFT": [Decimal("2"), Decimal("4"), Decimal("6"), Decimal("8")], # +1 correlation to AAPL
        "XYZ": [Decimal("8"), Decimal("6"), Decimal("4"), Decimal("2")]   # -1 correlation to AAPL and MSFT
    }
